...
namespace nzg
{
     ...
     * functions.
     *
     * All functions here will throw nzg::StringUtils::StringException
     * on an error. Any std::exception is converted to a
     * nzg::StringUtils::StringException so
    ...
    namespace StringUtils
    {
        ...
        /// nzg::StringUtils function fails.
        ...
        inline
            std::string& stripLeading(std::string& s,
                ...
                std::string::size_type num = std::string::npos) throw(StringException);
...
namespace nzg
{
    ...
    namespace StringUtils
    {
        ...
        {
            std::string toReturn;
            short exponentLength = (short)expLen;
