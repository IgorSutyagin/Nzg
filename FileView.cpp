...
BEGIN_MESSAGE_MAP(CFileView, CDockablePane)
	...
	ON_WM_PAINT()
	ON_WM_SETFOCUS()
	ON_COMMAND(ID_NZG_VIEW, OnNzgView)
END_MESSAGE_MAP()
...
void CFileView::OnContextMenu(CWnd* pWnd, CPoint point)
{
	...
	auto getMenuIndex = [](nzg::TreeCursor t) {
...
void CFileView::OnNzgView()
{
	CNzgApp* pApp = (CNzgApp*)AfxGetApp();
